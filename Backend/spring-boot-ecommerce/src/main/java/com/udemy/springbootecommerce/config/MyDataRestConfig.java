package com.udemy.springbootecommerce.config;
...
import com.udemy.springbootecommerce.entity.Product;
import com.udemy.springbootecommerce.entity.ProductCategory;
import com.udemy.springbootecommerce.entity.State;
...
public class MyDataRestConfig implements RepositoryRestConfigurer {
	...
	private void exposeIds(RepositoryRestConfiguration config) {
		...
		// -get a list of all the entity classes from the entity manger
