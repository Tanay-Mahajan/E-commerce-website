...
import { interactionCodeFlow } from './client/interactionCodeFlow.js';
...
class BaseLoginRouter extends Router {
  ...
  async handleUpdateAppState(idxResponse) {
    ...
    if (this.hasAuthenticationSucceeded(idxResponse) && this.settings.get('features.rememberMyUsernameOnOIE')) {
  ...
  handleError(error = {
    ...
    this.settings.callGlobalError(originalError); // -- TODO: OKTA-244631 How to surface up the CORS error in IDX?
  ...
  updateIdentifierCookie(idxResponse) {
    if (this.settings.get('features.rememberMe')) {
      ...
      const user = idxResponse === null || idxResponse === void 0 ? void 0 : (_idxResponse$context2 = idxResponse.context) === null || _idxResponse$context2 === void 0 ? void 0 : _idxResponse$context2.user;
      const {
  ...
  restartLoginFlow() {
    ...
    this.settings.unset('otp'); // Re-render the widget
