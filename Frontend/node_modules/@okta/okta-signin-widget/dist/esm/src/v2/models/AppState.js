...
import { FORMS_FOR_VERIFICATION, FORMS_WITHOUT_SIGNOUT, FORMS_WITH_STATIC_BACK_LINK, AUTHENTICATOR_KEY } from '../ion/RemediationConstants.js';
...
class AppState extends Model {
  ...
  async setIonResponse(transformedResponse, hooks) {
    ...
    if (doRerender) {
      ...
      const hook = hooks === null || hooks === void 0 ? void 0 : hooks.getHook(currentFormName); // may be undefined
